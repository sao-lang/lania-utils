...
export class Message {
    ...
    constructor() {
        ...
        this.addStyles(); // Add styles to document head
    }
    ...
    private addStyles(): void {
        if (document.querySelector('#global-message-styles')) return; // Prevent duplicate style tags

        const style = document.createElement('style');
        style.id = 'global-message-styles'; // Unique id to avoid duplicates
        style.textContent = `
